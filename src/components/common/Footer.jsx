...
export const Footer = () => {
  return (
    <footer className="bg-[#1C1C1C] text-[#9D9D9D] border-t border-white/5 pt-28 pb-16 px-6 lg:px-12 mt-32">
      <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 pb-20 border-b border-white/5">
      ...
      <div className="max-w-[1440px] mx-auto pt-10 flex flex-col md:flex-row items-center justify-between text-[11px] font-mono text-[#9D9D9D] tracking-wider uppercase gap-4">
